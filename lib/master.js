...
Master.prototype = {
	...
	start: function() {
		...
		self.client_sock.on("message", function(msg){
			console.log("Receiving client command.");
		...
		console.log("Listening on " + "tcp://" + this.config.master_bindaddr + ":" + this.config.master_port + " for slaves");
		console.log("Listening on " + "tcp://" + this.config.master_bindaddr + ":" + this.config.master_client_port + " for clients");
	},
